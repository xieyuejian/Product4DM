 ...
 */
@MappedSuperclass
public class StdDelivery extends BaseEntity<Long> {
	...
	/** 送货明细 */
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "delivery", orphanRemoval = true)
	protected List<DeliveryDtl> deliveryDtls;
	/** 快递信息 */
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "delivery", orphanRemoval = true)
	protected List<DeliveryExpressDtl> deliveryExpressDtls;

	public List<DeliveryExpressDtl> getDeliveryExpressDtls() {
		return deliveryExpressDtls;
	}

	public void setDeliveryExpressDtls(List<DeliveryExpressDtl> deliveryExpressDtls) {
		this.deliveryExpressDtls = deliveryExpressDtls;
	}

	public List<DeliveryDtl> getDeliveryDtls() {
		return deliveryDtls;
	}

	public void setDeliveryDtls(List<DeliveryDtl> deliveryDtls) {
	...
	public StdDelivery(Long deliveryId) {
		this.deliveryId = deliveryId;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StdDelivery other = (StdDelivery) obj;
		if (deliveryId == null) {
